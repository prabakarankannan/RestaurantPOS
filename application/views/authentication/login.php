                    ...
                    <div class="login-box-body px-3">
                        ...
                        <div class="col-sm-12 mb-3">
                            <div class="form-group has-feedback">
                                <input type="text" class="form-control" name="email_address" id="email_address"
                                    ...
                                    value="<?php if(APPLICATION_MODE == 'demo'){ echo "admin@test.com"; }else{ echo '';} ?>">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 mb-2 col-md-6">
                                <button type="button" data-username="admin@test.com" data-password="123456" name="button" class="btn w-100 bg-blue-btn set_credentials">Supper Admin</button>
                            </div>
                            <div class="col-sm-12 mb-2 col-md-6">
